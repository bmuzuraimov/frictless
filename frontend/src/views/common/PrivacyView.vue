<template>
  <CommonLayout>
    <div class="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg">
      ...
      <h1 class="text-4xl font-bold text-primary-700 mb-4">Privacy Policy</h1>
      <p class="text-primary-600 mb-2">Last updated: February 06, 2024</p>
      <p class="mb-4">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Frictless Ltd., 224
            Waterloo Rd, Kowloon Tong .
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>By email: bmuzuraimov@gmail.com</li>
      </ul>
    </div>
  </CommonLayout>
</template>
