<template>
  <CommonLayout>
    <div class="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg">
      ...
      <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <p class="mb-4">
          We are Frictless Ltd. ("Company," "we," "us," "our"), a company registered in Kyrgyzstan
          at Isanova St., Bishkek, Chui 720000.
        </p>
        <p class="mb-4">
        ...
        <p class="mb-4">
          Frictless helps manage time and tasks. It uses scheduling algorithms and voice interaction
          to organize both academic and personal tasks. Users can add tasks using voice commands,
          and the app schedules these tasks by considering their priority, deadlines, and duration.
          Nodeon integrates with Notion to display tasks, course materials, and schedules in one
          place. It also prioritizes tasks to ensure important ones are done first and syncs with
          wearable devices to alert users about upcoming tasks. This app is aimed at helping
          students stay organized and efficient.
        </p>
        <p class="mb-4">
          You can contact us by email at bmuzuraimov@gmail.com or by mail to 224 Waterloo Rd,
          Kowloon Tong, Kowloon, Hong Kong.
        </p>
        <p class="mb-4">
          These Legal Terms constitute a legally binding agreement made between you, whether
          personally or on behalf of an entity ("you"), and Frictless Ltd., concerning your access
        ...
        <ul class="list-disc pl-5 mb-8">
          ...
          <li>18. MODIFICATIONS AND INTERRUPTIONS</li>
          <li>19. GOVERNING LAW</li>
          <li>20. DISPUTE RESOLUTION</li>
          <li>21. CORRECTIONS</li>
          <li>22. DISCLAIMER</li>
          <li>23. LIMITATIONS OF LIABILITY</li>
          <li>24. INDEMNIFICATION</li>
          <li>25. USER DATA</li>
          <li>26. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</li>
          <li>27. CALIFORNIA USERS AND RESIDENTS</li>
          <li>28. MISCELLANEOUS</li>
          <li>29. CONTACT US</li>
        </ul>

        <h2 class="text-2xl font-semibold mb-3">1. OUR SERVICES</h2>
        <p class="mb-4">
        ...
        <h2 class="text-2xl font-semibold mb-3">2. INTELLECTUAL PROPERTY RIGHTS</h2>
        <p class="mb-4"><strong>Our intellectual property</strong></p>
        <p class="mb-4">
        ...
        <p class="mb-4"><strong>Your use of our Services</strong></p>
        <p class="mb-4">
          ...
          the Services; and download or print a copy of any portion of the Content to which you have
        ...
        <p class="mb-4">
          ...
          bmuzuraimov@gmail.com. If we ever grant you the permission to post, reproduce, or publicly
        ...
        <p class="mb-4"><strong>Your submissions</strong></p>
        <p class="mb-4">
        ...
        <p class="mb-4">
          ...
          inaccurate, deceitful, or misleading; to the extent permissible by applicable law, waive
          any and all moral rights to any such Submission; warrant that any such Submission are
          original to you or that you have the necessary rights and licenses to submit such
          Submissions and that you have full authority to grant us the above-mentioned rights in
          relation to your Submissions; and warrant and represent that your Submissions do not
          constitute confidential information. You are solely responsible for your Submissions and
        ...
        <h2 class="text-2xl font-semibold mb-3">3. USER REPRESENTATIONS</h2>
        <p class="mb-4">
          ...
          received parental permission to use the Services; (5) you will not access the Services
          through automated or non-human means, whether through a bot, script or otherwise; (6) you
          will not use the Services for any illegal or unauthorized purpose; and (7) your use of the
        ...
        <h2 class="text-2xl font-semibold mb-3">4. USER REGISTRATION</h2>
        ...
        <h2 class="text-2xl font-semibold mb-3">5. PURCHASES AND PAYMENT</h2>
        ...
        <p class="mb-4">
          ...
          any such amounts upon placing your order. If your order is subject to recurring charges,
          ...
          applicable order. We reserve the right to correct any errors or mistakes in pricing, even
        ...
        <h2 class="text-2xl font-semibold mb-3">6. FREE TRIAL</h2>

        <p class="mb-4">
          We offer a 90-day free trial to new users who register with the Services. follow fremium
          subscription
        </p>

        <h2 class="text-2xl font-semibold mb-3">7. CANCELLATION</h2>
        ...
        <p class="mb-4">
          If you are unsatisfied with our Services, please email us at bmuzuraimov@gmail.com.
        </p>

        <h2 class="text-2xl font-semibold mb-3">8. PROHIBITED ACTIVITIES</h2>
        ...
        <h2 class="text-2xl font-semibold mb-3">9. USER GENERATED CONTRIBUTIONS</h2>
        ...
        or make available any Contributions, you thereby represent and warrant that: The creation,
        ...
        of any third party. You are the creator and owner of or have the necessary licenses, rights,
        consents, releases, and permissions to use and to authorize us, the Services, and other
        users of the Services to use your Contributions in any manner contemplated by the Services
        and these Legal Terms. You have the written consent, release, and/or permission of each and
        every identifiable individual person in your Contributions to use the name or likeness of
        each and every such identifiable individual person to enable inclusion and use of your
        Contributions in any manner contemplated by the Services and these Legal Terms. Your
        Contributions are not false, inaccurate, or misleading. Your Contributions are not
        unsolicited or unauthorized advertising, promotional materials, pyramid schemes, chain
        letters, spam, mass mailings, or other forms of solicitation. Your Contributions are not
        ...
        intimidate, or abuse anyone. Your Contributions are not used to harass or threaten (in the
        legal sense of those terms) any other person and to promote violence against a specific
        person or class of people. Your Contributions do not violate any applicable law, regulation,
        or rule. Your Contributions do not violate the privacy or publicity rights of any third
        party. Your Contributions do not violate any applicable law concerning child pornography, or
        otherwise intended to protect the health or well-being of minors. Your Contributions do not
        include any offensive comments that are connected to race, national origin, gender, sexual
        preference, or physical handicap. Your Contributions do not otherwise violate, or link to
        material that violates, any provision of these Legal Terms, or any applicable law or
        regulation. Any use of the Services in violation of the foregoing violates these Legal Terms
        and may result in, among other things, termination or suspension of your rights to use the
        Services.

        <h2 class="text-2xl font-semibold mb-3">10. CONTRIBUTION LICENSE</h2>
        ...
        <p class="mb-4">
          ...
          (including settings). By submitting suggestions or other feedback regarding the Services,
          you agree that we can use and share such feedback for any purpose without compensation to
          you. We do not assert any ownership over your Contributions. You retain full ownership of
        ...
        <h2 class="text-2xl font-semibold mb-3">11. GUIDELINES FOR REVIEWS</h2>
        ...
        <p class="mb-4">
          ...
          negative. We may accept, reject, or remove reviews in our sole discretion. We have
        ...
        <h2 class="text-2xl font-semibold mb-3">12. SOCIAL MEDIA</h2>
        ...
        <p class="mb-4">
          ...
          the Services and your Third-Party Accounts at any time. PLEASE NOTE THAT YOUR RELATIONSHIP
          WITH THE THIRD-PARTY SERVICE PROVIDERS ASSOCIATED WITH YOUR THIRD-PARTY ACCOUNTS IS
          GOVERNED SOLELY BY YOUR AGREEMENT(S) WITH SUCH THIRD-PARTY SERVICE PROVIDERS. We make no
          effort to review any Social Network Content for any purpose, including but not limited to,
          ...
          who have also registered to use the Services. You can deactivate the connection between
          the Services and your Third-Party Account by contacting us using the contact information
          below or through your account settings (if applicable). We will attempt to delete any
          information stored on our servers that was obtained through such Third-Party Account,
          except the username and profile picture that become associated with your account.
        </p>

        <h2 class="text-2xl font-semibold mb-3">13. THIRD-PARTY WEBSITES AND CONTENT</h2>
        ...
        <h2 class="text-2xl font-semibold mb-3">14. ADVERTISERS</h2>
        ...
        <h2 class="text-2xl font-semibold mb-3">15. SERVICES MANAGEMENT</h2>
        ...
        <h2 class="text-2xl font-semibold mb-3">16. PRIVACY POLICY</h2>

        <p class="mb-4">
          We care about data privacy and security. Please review our Privacy Policy:
          http://www.frictless.com/privacy. By using the Services, you agree to be bound by our
          Privacy Policy, which is incorporated into these Legal Terms. Please be advised the
          Services are hosted in Singapore. If you access the Services from any other region of the
          world with laws or other requirements governing personal data collection, use, or
          disclosure that differ from applicable laws in Singapore, then through your continued use
          of the Services, you are transferring your data to Singapore, and you expressly consent to
          have your data transferred to and processed in Singapore.
        </p>

        <h2 class="text-2xl font-semibold mb-3">17. TERM AND TERMINATION</h2>
        ...
        <p class="mb-4">
          ...
          INFORMATION THAT YOU POSTED AT ANY TIME, WITHOUT WARNING, IN OUR SOLE DISCRETION. If we
        ...
        <h2 class="text-2xl font-semibold mb-3">18. MODIFICATIONS AND INTERRUPTIONS</h2>
        ...
        <p class="mb-4">
          ...
          for any modification, price change, suspension, or discontinuance of the Services. We
          cannot guarantee the Services will be available at all times. We may experience hardware,
        ...
        <p class="mb-4">
          ...
          Frictless Ltd. and yourself irrevocably consent that the courts of Hong Kong shall have
          exclusive jurisdiction to resolve any dispute which may arise in connection with these
          Legal Terms.
        </p>

        <h2 class="text-2xl font-semibold mb-3">20. DISPUTE RESOLUTION</h2>

        <p class="mb-4">
          Binding Arbitration Any dispute arising out of or in connection with these Legal Terms,
          including any question regarding its existence, validity, or termination, shall be
          referred to and finally resolved by the International Commercial Arbitration Court under
          the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the
          Rules of this ICAC, which, as a result of referring to it, is considered as the part of
          this clause. The number of arbitrators shall be three (3). The seat, or legal place, or
          arbitration shall be Hong Kong, Hong Kong. The language of the proceedings shall be
          English. The governing law of these Legal Terms shall be substantive law of Hong Kong.
          ...
          shall be joined with any other proceeding; (b) there is no right or authority for any
          ...
          representative capacity on behalf of the general public or any other persons. Exceptions
          to Arbitration The Parties agree that the following Disputes are not subject to the above
          provisions concerning binding arbitration: (a) any Disputes seeking to enforce or protect,
        ...
        <h2 class="text-2xl font-semibold mb-3">21. CORRECTIONS</h2>
        ...
        <h2 class="text-2xl font-semibold mb-3">22. DISCLAIMER</h2>
        ...
        <h2 class="text-2xl font-semibold mb-3">23. LIMITATIONS OF LIABILITY</h2>
        ...
        <p class="mb-4">
          ...
          THE LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US OR $0.00 USD. CERTAIN US STATE LAWS
        ...
        <h2 class="text-2xl font-semibold mb-3">24. INDEMNIFICATION</h2>
        ...
        <h2 class="text-2xl font-semibold mb-3">25. USER DATA</h2>
        ...
        <h2 class="text-2xl font-semibold mb-3">27. CALIFORNIA USERS AND RESIDENTS</h2>
        ...
        <h2 class="text-2xl font-semibold mb-3">28. MISCELLANEOUS</h2>
        ...
        <h2 class="text-2xl font-semibold mb-3">29. CONTACT US</h2>
