            ...
            <ul class="divide-y">
              <li v-for="(item, idx) in navigations" :key="idx" class="flex gap-x-4 py-6">
                ...
                <div class="space-y-1">
                  ...
                  <router-link :to="item.href" class="text-sm text-indigo-600 duration-150 hover:text-indigo-400 font-medium inline-flex items-center gap-x-1">
                    Visit
      ...
      return {
        navigations: [
          ...
          },
          {
            ...
            title: 'Guide',
            desc: 'How to get most out of our platform',
            href: '/guide'
          },
          {
