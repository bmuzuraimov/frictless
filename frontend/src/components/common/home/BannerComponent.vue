<template>
  <Transition name="slide-fade">
    <div v-if="show" class="bg-indigo-600">
      <div
        class="max-w-screen-xl mx-auto px-4 py-3 flex items-start justify-between text-white md:px-8"
      >
        <div class="flex gap-x-4">
          <div
            class="w-10 h-10 flex-none rounded-lg bg-indigo-800 flex items-center justify-center"
          >
            <svg
              class="w-6 h-6"
        ...
        <button
          @click="close"
          class="p-2 rounded-lg duration-150 hover:bg-indigo-500 ring-offset-2 focus:ring"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20"
