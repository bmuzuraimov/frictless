  ...
  >
    <div class="space-y-4 sm:space-y-5 max-w-xl md:max-w-3xl lg:max-w-4xl mx-auto text-center">
      ...
      <p class="text-sm sm:text-md font-ourfit leading-normal text-gray-600 mx-auto">
        Frictless transforms your Notion workspace into an intelligent daily planner, prioritizing your tasks and optimizing your schedule with just a whisper to Siri or a click.
      </p>
      <p class="text-xs sm:text-sm text-indigo-600 font-medium">No credit card required - experience the ease today!</p>
      <div
